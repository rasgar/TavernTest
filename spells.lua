...
SpellInfo = {
  ['Default'] = {
	--[[I added a spell to the spell list to try casting the spell that way, while I tried to figure out how to make the spell work in game.
	I did so by copying the entry for Eternal Winter, guessing from the icon in the in-game spell list that it would be the closest to the video you sent.
	At this point I was unable to actually cast Eternal Winter to test it because I couldn't figure out how to give my account premium status.
	It was only after my testing didn't work that I found spells.xml and made changes there.]]--
    ['Frigo Time'] =               {id = 118, words = 'frigo',                 exhaustion = 300,   premium = false, type = 'Instant', icon = 'eternalwinter',          mana = 10,     level = 60, soul = 0, group = {[1] = 4000},               vocations = {2, 6}},
    ...
    ['Eternal Winter'] =           {id = 118, words = 'exevo gran mas frigo',  exhaustion = 40000, premium = false, type = 'Instant', icon = 'eternalwinter',          mana = 1050,   level = 60, soul = 0, group = {[1] = 4000},               vocations = {2, 6}},
